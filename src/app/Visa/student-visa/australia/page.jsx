...
export default function Australia(){
  ...
  const structuredData = {
    ...
    "description": "Helping international students apply for Australian student visas and choose the best courses and universities in Australia.",
    "address": {
      "@type": "PostalAddress",
        ...
        <img src="/images/Australia1.png" alt="Australia Image" className={styles.AustraliaImage} />
               ...
               <div className={styles.AustraliaSec}>
                      ...
                      <div className={styles.AustraliaData}>
                          <h1 className={styles.Title}>Unlock Your Australian Education Dream: Your Comprehensive Guide to a Student Visa</h1>
