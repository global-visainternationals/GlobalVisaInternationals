...
export default function Home() {
  ...
  const visaTypes = [
    ...
    { type: "Student Visa", image: "/images/visa.webp", link: "/tourist-visa", countries: ["canada", "australia", "usa", "uk", "europe", "new-zealand"] },
      ...
      <section className={styles.services}>
          ...
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/Tourist-Visa.webp" alt="Business Visa" />
        ...
        <div className={styles.visaCard}>
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/business-visa.webp" alt="Business Visa" />
        ...
        <div className={styles.visaCard}>
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/PR-Visa.webp" alt="Permanent Resident Visa" />
                <h3>Permanent Resident visa Assistance</h3>
              </div>
              <div className={styles.top2}>
        ...
        <div className={styles.visaCard}>
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/student-visa.webp" alt="Business Visa" />
                <h3>Student Visa Assistance</h3>
              </div>
              <div className={styles.top2}>
        ...
        <div className={styles.visaCard}>
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/Dependent Visa.webp" alt="Business Visa" />
        ...
        <div className={styles.visaCard}>
          <div className={styles.cardInner}>
            <div className={styles.cardFront}>
              <div className={styles.top1}>
                <img src="/images/svg/refusal visa.webp" alt="Business Visa" />
                <h3>Student Visa Assistance</h3>
              </div>
              <div className={styles.top2}>
                Contact Global Visa Internationals For Business Visa assistance
